...
template["source"] = (
    "Given the following purchase history of user_{} : \n {} \n predict next possible item to be purchased by the user ?"
)
template["target"] = "{}"
...
template["source"] = (
    "Here is the purchase history of user_{}: {}. What to recommend next for the user?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
template["id"] = "2-1-0"
template["candidates"] = "{}"
template["candidates_argc"] = 1
template["candidates_argv"] = ["candidates"]
task_subgroup_2["2-1-0"] = template
...
template["source"] = (
    "Here is the profile of user_{}: gender is male. Here is the purchase history: {}. What to recommend next for the user?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
task_subgroup_2["2-1-1"] = template
...
template["source"] = (
    "Here is the profile of user_{}: gender is female. Here is the purchase history: {}. What to recommend next for the user?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
task_subgroup_2["2-1-2"] = template
...
template["input_1"] = (
    "Given the following purchase history of user_{}: {} predict next possible item to be purchased by the user?"
)
template["input_2"] = (
    "I find the purchase history list of user_{}: {} I wonder which is the next item to recommend to the user. Can you help me decide?"
)
template["input_3"] = (
    "Here is the purchase history list of user_{}: {} try to recommend next item to the user"
)
template["input_4"] = (
    "Given the following purchase history of user_{}: {} predict the next possible item to be purchased by the user."
)
template["input_5"] = (
    "Based on the purchase history of user_{} : \n {} \n Can you decide the next item likely to be purchased by the user ?"
)
template["input_6"] = (
    "Here is the purchase history of user_{} : \n {} \n What to recommend next for the user ?"
)
template["input_7"] = (
    "Here is the purchase history of user_{} : \n {} \n Select the next possible item likely to be purchased by the user"
)
template["input_8"] = (
    "From the list of previous purchases by user_{}: \n {} \n, infer the next product this user might be interested in."
)

template["input_9"] = (
    "Analyzing the shopping behavior of user_{} based on their past purchases: \n {} \n Which product would be the most reasonable next recommendation?"
)
template["target"] = "{}"
template["candidates"] = "{}"
template["task"] = "sequential"
template["input_argc"] = 2
template["input_argv"] = ["user_id", "purchase_history"]
template["input_1_argc"] = 2
template["input_1_argv"] = ["user_id", "purchase_history"]
template["input_2_argc"] = 2
template["input_2_argv"] = ["user_id", "purchase_history"]
template["input_3_argc"] = 2
template["input_3_argv"] = ["user_id", "purchase_history"]
template["input_4_argc"] = 2
template["input_4_argv"] = ["user_id", "purchase_history"]
template["input_5_argc"] = 2
template["input_5_argv"] = ["user_id", "purchase_history"]
template["input_6_argc"] = 2
template["input_6_argv"] = ["user_id", "purchase_history"]
template["input_7_argc"] = 2
template["input_7_argv"] = ["user_id", "purchase_history"]
template["input_8_argc"] = 2
template["input_8_argv"] = ["user_id", "purchase_history"]
template["input_9_argc"] = 2
template["input_9_argv"] = ["user_id", "purchase_history"]
...
task_subgroup_2["2-1-3"] = template
...
template["source"] = (
    "Given the following demographic information of user_{}: age=25–34 and the purchase history: {} predict the next possible item to be purchased by the user."
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
task_subgroup_2["2-1-4"] = template
...
template["source"] = (
    "Given the following demographic information of user_{}: age=35–44 and the purchase history: {} predict the next possible item to be purchased by the user."
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
task_subgroup_2["2-1-5"] = template
...
"""
template["source"] = (
    "Here is the purchase history list of user_{} : \n {} \n try to recommend next item to the user"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
template["source"] = (
    "Given the following purchase history of {} : \n {} \n predict next possible item for the user"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "Based on the purchase history of {} : \n {} \n Can you decide the next item likely to be purchased by the user ?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "Here is the purchase history of {} : \n {} \n What to recommend next for the user ?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "The user_{} has recently purchased the following items : \n {} \n What item should come next in the sequence?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "Based on the interaction history of user_{}: \n {} \n Which item is most likely to be bought next?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "From this list of past purchases by user_{}: \n {} \n Predict the next likely purchase."
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "Here’s what user_{} has bought so far: \n {} \n What’s the most logical next item?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "Considering user_{}’s purchase history: \n {} \n Please suggest the next item they might be interested in."
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "Following this sequence of purchases from user_{}: \n {} \n What would be your recommendation for the next item?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "I find the purchase history list of {} : \n {} \n I wonder which is the next item to recommend to the user . Try to select one from the following candidates : \n {}"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 3
...
"""
template["source"] = (
    "user_{} has the following purchase history : \n {} \n does the user likely to buy {} next ?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 3
...
"""
template["source"] = (
    "According to the purchase history of {} : \n {} \n Can you recommend the next possible item to the user ?"
)
template["target"] = "{}"
template["task"] = "sequential"
template["source_argc"] = 2
...
"""
template["source"] = (
    "Help user_{} generate a {}-star explanation about this product : \n {}"
)
template["target"] = "{}"
template["task"] = "explanation"
template["source_argc"] = 3
...
template["source"] = (
    "Predict the star rating , then use {} as feature word to generate user_{} 's purchase explanation for item_{}"
)
template["target"] = "{} , {}"
template["task"] = "explanation"
template["source_argc"] = 3
...
template["source"] = (
    "Based on the feature word {} , generate an explanation for user_{} about this product : {}"
)
template["target"] = "{}"
template["task"] = "explanation"
template["source_argc"] = 3
...
template["source"] = (
    "Given the word {} , can you help generate an explanation for {} about the product : \n {}"
)
template["target"] = "{}"
template["task"] = "explanation"
template["source_argc"] = 3
...
"""
template["source"] = (
    "Write a short sentence to summarize the following product review from user_{} : \n {}"
)
template["target"] = "{}"
